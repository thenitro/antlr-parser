...
namespace GoParseTree
{
    public abstract class GoParserBase : Parser
    {
        ...
        protected bool lineTerminatorAhead()
        {
            ...
            return type == 73 /*COMMENT*/ && (text.Contains("\r") || text.Contains("\n")) ||
                   type == 74;//TERMINATOR;
        }
        ...
        protected bool noTerminatorAfterParams(int tokenOffset)
        {
            ...
            if (LT(stream, tokenOffset).Type == 28) //L_PAREN)
            {
                ...
                while (leftParams != rightParams)
                {
                    ...
                    if (tokenType == 28)// L_PAREN)
                    {
                        leftParams++;
                    }
                    else if (tokenType == 29)//R_PAREN)
                    {
                        rightParams++;
                    }
                }
